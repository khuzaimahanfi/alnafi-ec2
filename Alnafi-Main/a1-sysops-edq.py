...
driver.find_element(By.XPATH, '//*[@id="__nuxt"]/div/section/div/div/div[1]/div[2]/a[3]/div').click()
time.sleep(5)

# yearly price
yearly_price = driver.find_element(By.XPATH, '//*[@id="__nuxt"]/div/div[4]/div/section[1]/div/div[1]/div[2]/div[1]/h3')
time.sleep(2)
yearly_act_price = "Rs 255,250"
time.sleep(2)
...
time.sleep(2)
half_yearly_act_price = "Rs 127,600"
time.sleep(2)
