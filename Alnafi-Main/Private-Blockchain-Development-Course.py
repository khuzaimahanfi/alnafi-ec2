...
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Private Blockchain Development Course')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 40000')]")
sleep(3)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 40000')]").click()
