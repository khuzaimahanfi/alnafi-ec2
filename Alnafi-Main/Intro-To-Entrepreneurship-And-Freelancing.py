...
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Intro To Entrepreneurship And Freelancing')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 4000')]")

sleep(5)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 4000')]").click()
