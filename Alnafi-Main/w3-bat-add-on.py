...
driver.get("https://alnafi.com/tracks/bataddon")
...
time.sleep(2)
yearly_act_price = "Rs Rs 164,249"
time.sleep(2)
...
time.sleep(2)
half_yearly_act_price = "Rs 82,125"
time.sleep(2)
