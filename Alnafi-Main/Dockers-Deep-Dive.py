...
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Dockers Deep Dive')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 42000')]")
sleep(3)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 42000')]").click()
