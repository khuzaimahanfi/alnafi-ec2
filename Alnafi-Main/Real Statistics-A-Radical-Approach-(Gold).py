...
driver.get("https://alnafi.com/courses/realstatistics-gold")
# driver.find_element(By.XPATH, "//*[contains(text(), 'Real Statistics: A Radical Approach (Gold)')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 10000')]")
sleep(3)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 10000')]").click()
