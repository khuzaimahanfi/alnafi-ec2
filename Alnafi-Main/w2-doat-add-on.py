...
driver.get("https://alnafi.com/tracks/dotaddon")
...
time.sleep(2)
yearly_act_price = "Rs Rs 178,500"
time.sleep(2)
...
time.sleep(2)
half_yearly_act_price = "Rs 89,250"
time.sleep(2)
