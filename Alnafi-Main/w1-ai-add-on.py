...
driver.get("https://alnafi.com/tracks/aict")
...
time.sleep(2)
yearly_act_price = "Rs Rs 183,750"
time.sleep(2)
...
time.sleep(2)
half_yearly_act_price = "Rs 91,875"
time.sleep(2)
