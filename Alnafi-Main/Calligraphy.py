...
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Calligraphy')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 3000')]")

sleep(5)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 3000')]").click()
