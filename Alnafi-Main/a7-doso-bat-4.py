...
driver.get("https://alnafi.com/tracks/dosobat")
...
time.sleep(2)
eighteen_month_act_price = "Rs Rs 563,112"
time.sleep(2)
...
time.sleep(2)
half_yearly_act_price = "Rs 140,778"
time.sleep(2)
