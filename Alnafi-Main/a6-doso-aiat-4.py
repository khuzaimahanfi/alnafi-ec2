...
driver.get("https://alnafi.com/tracks/dosoaiat")
...
time.sleep(2)
eighteen_month_act_price = "Rs Rs 581,638"
time.sleep(2)
...
time.sleep(2)
half_yearly_act_price = "Rs 145,410"
time.sleep(2)
