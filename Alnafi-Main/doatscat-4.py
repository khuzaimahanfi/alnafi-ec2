...
driver.get("https://alnafi.com/tracks/doatscat")
...
time.sleep(2)
eighteen_month_act_price = "Rs Rs 407,075"
time.sleep(2)
...
time.sleep(2)
half_yearly_act_price = "Rs 135,692"
time.sleep(2)
