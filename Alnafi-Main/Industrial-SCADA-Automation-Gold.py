...
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Industrial SCADA Automation - Gold')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 35000')]")
sleep(3)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 35000')]").click()
