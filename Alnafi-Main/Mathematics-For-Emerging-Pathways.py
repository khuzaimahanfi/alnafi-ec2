...
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Mathematics For Emerging Pathways')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 10500')]")

sleep(5)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 10500')]").click()
