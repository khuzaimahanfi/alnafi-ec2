...
sleep(2)
# driver.find_element(By.XPATH, "//*[contains(text(), 'Industrial SCADA Automation')]").click()
driver.get("https://alnafi.com/courses/industrial-scada-automation")
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 13200')]")
sleep(3)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 13200')]").click()
