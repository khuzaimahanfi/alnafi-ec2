...
driver.get("https://alnafi.com/courses/siemens-advanced")
# driver.find_element(By.XPATH, "//*[contains(text(), 'Siemens Advanced TIA Portal, S7-1200 PLC & WinCC H')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(1)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 2200')]")
sleep(3)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 2200')]").click()
