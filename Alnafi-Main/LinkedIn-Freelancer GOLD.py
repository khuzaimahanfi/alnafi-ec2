...
sleep(2)
driver.find_element(By.XPATH, "///p[normalize-space()='LinkedIn Course For Job Seekers, Freelancer GOLD']").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Add to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Go to Cart')]").click()
sleep(2)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 7500')]")

sleep(5)
driver.find_element(By.XPATH, "//*[contains(text(), 'Rs 7500')]").click()
