...
sleep(2)
driver.get("https://alnafi.com/courses/realstatistics-free")
# driver.find_element(By.XPATH, "//*[contains(text(), 'Real Statistics: A Radical Approach (Bronze)')]").click()
sleep(1)
driver.find_element(By.XPATH, "//button[normalize-space()='Join for Free']").click()
